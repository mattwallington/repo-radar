...
test('detectStableManaged is false with a legacy launcher, true when managed', () => {
  ...
  // remove legacy, add a compatible stable desired.json + current -> managed
  ...
  publishDesired(L.desired, { channel: 'stable', version: '1.0.27', genId: 'g1' });
